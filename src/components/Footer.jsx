...
function Footer() {
    return (
        <div className='flex gap-5 w-full h-screen bg-zinc-900 p-20'>
            <div className='w-1/2 font-sans h-full flex flex-col justify-between'>
                <div className='heading'>
                    <h1 className='text-[7vw] font-semibold uppercase leading-none -mb-13'>EYE-</h1>
                    <h1 className='text-[7vw] font-semibold uppercase leading-none -mb-13'>OPENING</h1>
                </div>
            ...
            <div className='w-1/2'>
                <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-13'>PRESENTATIONS</h1>
                <div className='dits font-mono mt-10'>
